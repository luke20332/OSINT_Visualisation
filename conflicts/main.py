...
remove_columns = [ 'territory_name','start_date', 
...
prio_df_more_features = prio_df.drop(remove_columns, axis=1)
...
prio_df_more_features.to_csv('OSINT_Visualisation\conflicts\\prio_df.csv', index=False)
#  export data to csv
...
plt.show()
######################################
# Frequency of conflicts by countr
